...
1. Copiar la dirección completa del enlace de instalación.
2. Abrir **Tampermonkey → Panel de control → Utilidades**.
3. Buscar **Instalar desde URL**, pegar la dirección y confirmar.

## Uso

Abrir normalmente un evento. Dentro del reproductor aparecerá arriba a la izquierda el botón verde **Reproducir limpio**. Al pulsarlo, el script reproduce el video, solicita pantalla completa e intenta orientar Android horizontalmente.

La pantalla completa requiere un clic o toque real por una restricción del navegador.

## Actualizaciones

Tampermonkey comprueba actualizaciones automáticamente. Cada versión nueva publicada en este repositorio se instalará cuando el gestor realice su siguiente comprobación.
